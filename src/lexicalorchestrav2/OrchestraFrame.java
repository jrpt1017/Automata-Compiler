...
//         tblLexeme.getColumnModel().getColumn(0).setPreferredWidth(10);
//         tblLexeme.getColumnModel().getColumn(1).setPreferredWidth(10);
//         tblLexeme.getColumnModel().getColumn(2).setPreferredWidth(10);
//         tblLexeme.getColumnModel().getColumn(3).setPreferredWidth(10);
...
//        }
        ...
        int rows = model.getRowCount(); //Deletes the Lexical Table
        for(int i = rows - 1; i >=0; i--)
        {
            model.removeRow(i);
        }

        int rowserror = error.getRowCount(); //Deletes the Lexical Error Table
        for(int i = rowserror - 1; i >=0; i--)
        {
            error.removeRow(i);
        }
        int check = 0;
...
//        {
//            case INTEGERLITERAL: case FLOATLITERAL: case CHARLITERAL: case STRINGLITERAL: case BOOLLITERAL:
//                addToSyntaxTable("<funcargs>","<literal>");
//                production_literal();
//                break;
//                
//            case IDENTIFIER:
//                addToSyntaxTable("<funcargs>","<identifier>");
//                production_identifier();
//                break;
//                
//            default: addToSyntaxErrorTable("<funcargs>","Expecting INTEGERLITERAL, FLOAT LITERAL, CHAR LITERAL, STRING LITERAL, BOOL LITERAL, IDENTIFER, ARRAY INDEX, STRUCT ID");    
//        }
//    }
